          ...
          <div className="relative">
            ...
            {showCreditPopup && (
              <div className="absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50">
                ...
                <button onClick={() => router.push("/pricing")} className="w-full bg-black text-white py-2 rounded-lg text-sm">
                  Buy more credits
                </button>
              </div>
            )}
          ...
          <div className="relative">
            ...
            {showUserPopup && (
              <div className="absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50">
                ...
                <button onClick={() => router.push("/history")} className="w-full text-left text-sm py-2 hover:text-black text-gray-600">
                  Interview History
                </button>
